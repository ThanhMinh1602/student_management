...
class _QuestionDialogState extends State<QuestionDialog> {
  ...
  // Trắc nghiệm
  final List<TextEditingController> optionsCtrl = List.generate(
    4,
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              //     DropdownMenuItem(value: QuestionType.typing, child: Text("Dịch câu")),
              //   ],
              // ),
              // const SizedBox(height: 16),
              ...
              // if (selectedType == QuestionType.typing) _buildTypingForm(),
