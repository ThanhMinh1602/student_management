...
class ClassManagementDetailView
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Obx(() {
                // if (controller.userInClass.isEmpty) {
  ...
  Widget _buildDataTable(BuildContext context) {
    return DataTable(
      ...
      rows:
          // controller.userInClass.map((student) {
          //   return
          [
            DataRow(
              cells: [
                DataCell(
                  Row(
                    children: [
                      CircleAvatar(
                        radius: 16,
                        backgroundColor: controller.primaryColor.withOpacity(
                          0.2,
                        ),
                        child: Text(
  ...
  void _showAddDialog(BuildContext context) {
    // final availableuser = controller.getAvailableuser();
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                ...
                //       final student = availableuser[index];
                //       return ListTile(
